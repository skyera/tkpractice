...
class VPaneFrame(ttk.Frame):
    ...
    def make_listbox(self):
        ...
        self.listbox.itemconfigure(0, background=self.listbox.cget('fg'),
                fg=self.listbox.cget('bg'))

    def make_vscrollbar(self):
        self.vscroll = ttk.Scrollbar(self.top_frame, orient=tk.VERTICAL, command=self.listbox.yview)
